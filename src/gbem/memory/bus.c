...
uint8_t mem_read(gb_t * gb, uint16_t addr) {
    ...
    else if (addr >= GB_WRAM_START && addr <= GB_WRAM_END) return               0xFF; // TODO: Update to ram_read in ram.c
    else if (addr >= GB_ECHO_START && addr <= GB_ECHO_END) return               0xFF; // TODO: Update to ram_read in ram.c
    ...
    else if (addr >= GB_HRAM_START && addr <= GB_HRAM_END) return               0xFF; // TODO: Update to ram_read in ram.c
...
void mem_write(gb_t *gb, uint16_t addr) {
    ...
    else if (addr >= GB_WRAM_START && addr <= GB_WRAM_END) return; // TODO: Update to ram_write in ram.c
    else if (addr >= GB_ECHO_START && addr <= GB_ECHO_END) return; // TODO: Update to ram_write in ram.c
    ...
    else if (addr >= GB_HRAM_START && addr <= GB_HRAM_END) return; // TODO: Update to ram_write in ram.c
